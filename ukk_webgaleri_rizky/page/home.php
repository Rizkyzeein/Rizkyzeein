<div class="container my-4 p-5 bg-hero rounded">
    <div class="py-5 text-white">
        <p class="display-5 fw-bold">Galeri Foto Rizky</p>
        <p class="fs-4 col-md-8">Selamat datang diweb galeriku, liat liat doang ga kasih like & komen yang bener aja</p>
    </div>
</div>
<div class="container">
    <div class="row">
        ...
        <div class="col-6 col-md-4 col-lg-3 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-danger">by: <?= $tampils['Username'] ?></p>
